...
<head>
    ...
    <title>Анкета Apachi Group</title>
    <!-- Font Awesome -->
...
<form id="formReg">
 ...
 <div class="header blue-gradient">
            ...
            <div class="row d-flex justify-content-center">
                <h3 class="white-text mb-3 pt-3 font-weight-bold">Apachi Group</h3>
            </div>
...
<div stepindex="0">
    ...
    <div class="card-body">
        ...
        <p class="card-text">
Вы хотите приобрести станок Apachi Group , но у Вас нет свободных средств? Мы поможем Вам оформить кредит на любой для Вас удобный срок. Кредит оформляется через банки-партнеры. Никаких справок, поручителей и беготни по отделениям. Все просто и в одном месте. Вам остается только следовать инструкциям и корректно отвечать на вопросы. Спасибо за то, что Вы с нами!</p>
...
<div stepindex="1">
  ...
  <div class="md-form ">
    ...
    <label for="course" data-error="Данные отсутсвуют" data-success="Верно">Введите название и модель станка*</label>
</div>
 <div class="md-form ">
...
<div stepindex="5">
  <div class="card text-center">
    <div class="card-body">
        <h5 class="card-title" style="margin-bottom: 0px">Лица для экстренной связи</h5>
    ...
    <div class="md-form ">
        ...
        <label for="friend_name1" data-error="Данные совпадают с Вашим ФИО" data-success="Верно">Фамилия Имя Отчество первого контактного лица*</label>
    </div>
     <div class="md-form">
        <input type="tel" id="friend_phone1" name="friend_phone1" required class="form-control validate phoneMask" value="+7"  >
        <label for="friend_phone1" data-error="+7xxxxxxxxxx" data-success="Верно">Номер мобильного телефона (первого контактного лица)*</label>
    </div>

      <div class="md-form ">
        <input type="text" id="friend_name2" name="friend_name2" required class="form-control validate">
        <label for="friend_name2" data-error="Данные совпадают с Вашим ФИО" data-success="Верно">Фамилия Имя Отчество второго контактного лица*</label>
    </div>
     <div class="md-form">
