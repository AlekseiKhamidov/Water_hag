...
<form id="formReg">
 ...
 <div class="header blue-gradient">
            ...
            <div class="row d-flex justify-content-center">
                <h3 class="white-text mb-3 pt-3 font-weight-bold">Зенит</h3>
            </div>
...
<div stepindex="0">
    ...
    <div class="card-body">
        ...
        <p class="card-text">
Вы хотите купить оборудование компании «Зенит», но у Вас нет свободных средств? Мы поможем оформить Вам кредит на любой Вам удобный срок.

Кредит оформляется через 14 банков-партнеров. Никаих справок, поручителей и беготни по отделениям. Всё просто и в одном месте. Вам остается только следовать инструкции и корректно отвечать на вопросы.
