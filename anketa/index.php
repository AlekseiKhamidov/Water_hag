...
<head>
    ...
    <title>Анкета Актив Кредит</title>
    <!-- Font Awesome -->
...
<form id="formReg">
 ...
 <div class="header blue-gradient">
            ...
            <div class="row d-flex justify-content-center">
                <h3 class="white-text mb-3 pt-3 font-weight-bold">Актив Кредит</h3>
            </div>
...
<div stepindex="0">
    ...
    <div class="card-body">
        ...
        <p class="card-text">
Вы хотите совершить покупку, но у Вас нет свободных средств? Мы поможем оформить Вам кредит на любой Вам удобный срок.
...
<div stepindex="1">
   <div class="card text-left">
    <div class="card-body">
        <h5 class="card-title" style="margin-bottom: 0px">Название товара/услуги и срок кредита</h5>
    ...
    <label for="course" data-error="Введите название товара/услуги" data-success="Верно">Введите название товара/услуги*</label>
</div>
 <div class="md-form ">
    ...
    <label for="price" data-error="Укажите стоимость товара/услуги" data-success="Верно">Укажите стоимость товара/услуги*</label>
</div>
...
<script>
 ...
 $(function() {
   preload("Актив-кредит","pos-credit");
  $("#paginator").hide();
