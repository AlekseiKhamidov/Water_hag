...
var FilterMenu = function () {
    ...
    FilterMenu.prototype.initialize = function () {
        ...
        this.th.getElementsByClassName("th-inner")[0].style.float = "left";
        this.th.appendChild(this.menu);
//this.th.getElementsByClassName("th-inner")[0].appendChild(this.menu);

     //this.th.getElementsByClassName("fht-cell")[0].appendChild(this.menu);
    ...
    FilterMenu.prototype.dropdownFilterItem = function (td, self) {
        ...
        var dropdownFilterItem = document.createElement('label');
        dropdownFilterItem.className = 'dropdown-item';
    ...
    FilterMenu.prototype.dropdownFilterItemSelectAll = function () {
        ...
        var dropdownFilterItemSelectAll = document.createElement('label');
        dropdownFilterItemSelectAll.className = 'dropdown-item';
        var input = document.createElement('input');
        input.type = 'checkbox';
        ...
        dropdownFilterItemSelectAll.appendChild(divider);
    ...
    FilterMenu.prototype.dropdownFilterContent = function () {
        ...
        dropdownFilterContent.className = 'dropdown-menu dropdown-menu-right';
    ...
    FilterMenu.prototype.dropdownFilterDropdown = function () {
        ...
        dropdownFilterDropdown.className = 'btn-group';
        dropdownFilterDropdown.style.marginTop = '8px';
        ...
        icon.className = 'fa fa-toggle-down';
      //  arrow.appendChild(icon);
    //    button.appendChild(icon);
        dropdownFilterDropdown.appendChild(button);
...
$$1.fn.excelTableFilter = function (options) {
    ...
    if (typeof options.columnSelector === 'undefined') options.columnSelector = '.excel-filter';
    if (typeof options.sort === 'undefined') options.sort = false;
