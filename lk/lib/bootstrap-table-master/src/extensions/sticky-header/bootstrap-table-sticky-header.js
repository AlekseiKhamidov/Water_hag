...
(function ($) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $("#s4-workspace").on('scroll.'+table_id, table, render_sticky_header);
        ...
        function render_sticky_header(event) {
            ...
            if (t > e && t <= e_end) {
                ...
                var scrollable_div = $('<div class='+randomdiv+' style="position:absolute;width:100%;overflow-x:hidden;" />');
