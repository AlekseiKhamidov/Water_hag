...
<head>
    ...
    <title>Анкета Like Finance</title>
    <!-- Font Awesome -->
...
<form id="formReg">
 ...
 <div class="header blue-gradient">
            ...
            <div class="row d-flex justify-content-center">
                <h3 class="white-text mb-3 pt-3 font-weight-bold">Like Finance</h3>
            </div>
...
<div stepindex="1">
   <div class="card text-left">
    <div class="card-body">
        <h5 class="card-title" style="margin-bottom: 0px">Название курса и срок кредита</h5>
  ...
  <div class="md-form ">
    ...
    <label for="course" data-error="Данные отсутсвуют" data-success="Верно">Введите название курса*</label>
</div>
<div class="md-form ">
